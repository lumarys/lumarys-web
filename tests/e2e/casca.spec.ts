...
test("o 404 oferece a home e a trilha, não só a tela de estudo", async ({ page }) => {
  ...
  // Um atalho por trilha do catálogo: eram um, viraram quatro com Analytics,
  // Cloud Practitioner e Solutions Architect.
  await expect(page.getByRole("link", { name: /ver a trilha de/i })).toHaveCount(4);
